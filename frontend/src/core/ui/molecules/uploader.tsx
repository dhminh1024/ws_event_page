import {
  ...
  import { File, FileImage, FileText, FileVideo, IconProps } from 'phosphor-react'
  ...
  export const FileIcon = ({ type, ...props }: { type?: string } & IconProps) => {
    ...
    return <File className="text-primary" size={30} weight="duotone" {...props} />
  }
    ...
    return (
      <div
        ...
        className={`relative w-full ${
          isLOF ? 'cursor-not-allowed opacity-50 hidden' : 'cursor-pointer '
        }`}
      >
        <div
          className={cn(
