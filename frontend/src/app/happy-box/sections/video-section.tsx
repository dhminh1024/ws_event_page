  ...
  return (
    <section className="relative">
      <BackgroundCloud className={cn("", className)}>
        <div className="container relative z-10 md:px-[60rem]">
          <div className="aspect-[560/376] mx-auto w-[90%] md:w-[60%] pt-[30rem] md:pt-[80rem]">
            <iframe
          ...
          <div className="relative md:w-[80%] mx-auto my-[20rem] md:mt-[50rem]">
            ...
            <Typography.Paragraph className="w-full text-[12rem] md:text-[26rem] text-happy_box-light_yellow absolute top-[50%] left-0 text-center translate-y-[-60%]">
          ...
          <div className="font-playlist text-center">
            ...
            <Typography.Paragraph className="text-[22rem] md:text-[50rem] text-happy_box-brick">
              ...
              <Typography.Text className="text-happy_box-light_yellow mx-[10rem] text-[22rem] md:text-[50rem]">
