...
export const ThankYouModal: FC<LunarModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent
        className={cn(
          "max-w-1920 mx-auto w-[92vw] bg-transparent border-none shadow-none",
          className
        )}
      >
        <div className="relative">
          ...
          <LunarScroll scrollSize={isDesktop ? 30 : 20}>
            <div className="p-80 md:px-40">
              <Typography.Paragraph className="text-[40rem] md:text-[60rem] leading-[1.2] mb-40 text-center text-happy_box-light_red font-playlist">
