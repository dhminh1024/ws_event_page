  ...
  ({ className, variant = "default", children, ...props }, ref) => {
    return (
      <Button
        ref={ref}
        className={cn(
          "relative text-[#803700] inline-flex px-[30rem] h-[46rem] uppercase leading-[1] text-[20rem] rounded-[13rem] overflow-hidden shadow-[5rem_5rem_8rem_#0e0d0d83] !bg-transparent border-none outline-none",
          className
        )}
        style={{
