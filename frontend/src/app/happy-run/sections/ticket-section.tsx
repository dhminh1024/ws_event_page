  ...
  return (
    <div className={cn("bg-hr-lime py-[40rem]", className)}>
      <div className="w-[90%] mx-auto">
        ...
        <center>
          <Typography.Paragraph className="text-[20rem] text-hr-blue">
            {t("happy_run.ticket_description")}
          </Typography.Paragraph>
        </center>
        <div
          className="flex gap-x-[10%] justify-center py-[40rem]"
          style={{
        ...
        >
          ...
          >
            ...
            <div className="absolute w-full h-full top-0 left-0 flex flex-col justify-center items-center">
              <Typography.Paragraph className="text-[36rem] drop-shadow-[0rem_10rem_5rem_#333] font-extrabold text-white uppercase">
                Well-Being
              </Typography.Paragraph>
              <Typography.Paragraph className="text-[80rem] leading-[70rem] font-extrabold text-hr-blue uppercase">
                {settings?.wellbeing_ticket_price.toLocaleString("vi-VN")}
                <span className="text-[40rem] ml-[10rem]">VND</span>
              </Typography.Paragraph>
            </div>
          </div>
          <div
        ...
        <center>
          <PrimaryButton className="h-auto p-[10rem_50rem] my-[20rem]">
