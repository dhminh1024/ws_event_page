...
import TicketWellbeingImage from "@happy-run/assets/images/ticket-well-being.webp";
import TicketHappyRunImage from "@happy-run/assets/images/ticket-happy-run.webp";
