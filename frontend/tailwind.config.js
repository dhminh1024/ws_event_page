  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        edges: ["Edges", "Mulish", "sans-serif"],
        ethnocentric: ["Ethnocentric", "Mulish", "sans-serif"],
      },
      colors: {
      ...
      backgroundImage: {
        "gs25-gradient":
          "linear-gradient(10deg,rgba(255, 100, 255, 1) 0%, rgba(171, 123, 255, 1) 22%, rgba(2, 169, 255, 1) 39%, rgba(140, 40, 255, 1) 69%);",
      },
      borderRadius: {
        lg: "var(--radius)",
